...
TODO добавить требования node + npm + gulp etc.
...
-  gulp
   ...
   -  include_pug2html - компиляция нужной страницы и всех остальных папок в src/pug/\*\*, кроме src/pug/pages (при отслеживании: следит за одной страницей в папке /src/pug/pages/\_index.pug и за всеми остальными папкими в src/pug/\*\*, кроме pages)
